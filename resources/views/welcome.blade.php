@php
    $legacyCatalog = require resource_path('storefront/legacy-catalog.php');
    $products = collect($legacyCatalog['products'])->map(fn (array $product): array => [
        ...$product,
        'image' => asset($product['image']),
    ])->all();
    $categories = collect($legacyCatalog['categories'])->map(fn (array $category): array => [
        ...$category,
        'image' => asset($category['image']),
    ])->all();
    $reviews = $legacyCatalog['reviews'];
