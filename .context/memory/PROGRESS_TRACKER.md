...
| Prochain gate | 🚧 **Storefront MVP — prérequis** sur `codex/storefront-mvp-prerequisites` : fermer D-030 GLOBAL, puis corriger la récupération concurrente du paiement. Ensuite seulement : catalogue dynamique et provisionnement produit. P6-D1.1 est préservé, pas abandonné. |
