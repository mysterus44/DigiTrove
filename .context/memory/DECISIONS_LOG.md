...
17. **Rollback 000025** : supprime les triggers, révoque les `EXECUTE` runtime, drop les 16 fonctions puis les FK composites circulaires (**explicitement, jamais `CASCADE`**) et enfin les quatre tables — restaurant exactement la frontière `000024`.
