...
P6 CRM & MARKETING  : ███████░░░  P6-A0, P6-A1.0, P6-A1.1, P6-A1.2 TERMINÉS ET MERGÉS (P6-A1.2 = PR #34, merge 7dc78aff, CI #41, D-047) ; P6-A1.3 Explicit Historical Backfill = PROCHAIN GATE ACTIF ; P6-A2 (Segments) NON COMMENCÉ.
P7 BLOG & SEO       : ░░░░░░░░░░  0%
```
...
| Prochain gate | 🚧 P6-A1.2 TERMINÉ, MERGÉ ET VALIDÉ (PR #34, merge 7dc78aff, CI #41, D-047). **P6-A1.3 — Explicit Historical Commerce Rollup Backfill = GATE ACTIF** (migration 000024 : runs durables audités, snapshot d'attribution figé, keyset `(contact_id,currency)`, dry-run par défaut, `--execute` explicite, borné et resumable, enqueue vers P6-A1.2 uniquement). **P6-A2 (Typed Versioned CRM Segments) : architecture auditée/gelée (D-049), NON COMMENCÉ.** |
