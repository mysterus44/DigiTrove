...
/**
 * P7. The 301 table that preserves the SEO acquired by the legacy URLs.
 *
 * The real guards live in PostgreSQL — internal paths only, no self-loop, no 301 → 301 chain.
 * This form mirrors them so an operator gets a field error rather than a database exception,
 * but it is NOT the control: a row inserted by any other path meets exactly the same refusals.
 */
class RedirectResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Redirections 301';
