...
final class AnalyticsSalesTable extends Widget
{
    use AuthorizesAnalyticsDashboard;
    use InteractsWithPageFilters;

    protected string $view = 'filament.widgets.analytics-sales-table';
    ...
    public function result(): ?AnalyticsSales
    {
        try {
            return app(AnalyticsSalesQuery::class)->get(
                $this->currency(),
                $this->from(),
                $this->to(),
                $this->page,
