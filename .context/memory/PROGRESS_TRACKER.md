...
| Prochain gate | 🚧 P6-A2 mergé (PR #36, D-049/D-050). **P6-B0 (D-052) et P6-B1 (D-054) implémentés, en attente de PR/CI. P6-C — Paniers / Relances = PROCHAIN GATE, NON COMMENCÉ** (architecture gelée D-055). |
