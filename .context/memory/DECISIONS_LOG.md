...
TESTS (**campagnes ciblées** ; la suite complète locale couvre le stack B0+B1) : P6B1 **101 tests** — Schema (11), Generation (8), CsvSafety (24), Download (8), Authorization (13), Expiration (8), Rollback (1), SecurityContract (11) — et **B0+B1 agrégé 197 tests / 1112 assertions**. Pint **463 fichiers**. **43 migrations**, `000027` présente, `000028` absente.
