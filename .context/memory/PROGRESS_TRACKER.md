...
| Prochain gate | ✅ P6-B0 (#37), P6-B1 (#38) et P6-C (#39, merge `a5de60a`) **MERGÉS**, CI SUCCESS. **P6-D — Affiliation = PROCHAIN GATE, NON COMMENCÉ**, architecture **non gelée** : à auditer avant toute décision. Aucune migration `000029`. ⚠️ Dettes ouvertes : **D-030 GLOBAL** (P4-C `assertMailerSafe()` plus faible sur cinq points, à durcir dans son propre gate) et **absence de flux panier applicatif** (P6-C reste dormant tant qu'un storefront ne crée pas de paniers). |
